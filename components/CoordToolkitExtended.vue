...
import mutations from "../store/mutationsCoordToolkitExtended";
 ...
 * @module modules/coordToolkitExtended/components/CoordToolkitExtended
 * @vue-data {Object} eventHandler - The Cesium Event Handler.
 */
export default {
    name: "CoordToolkitExtended",
    components: {
        NavTab,
        InputText,
        FlatButton
    ...
    computed: {
        ...mapGetters("Modules/CoordToolkitExtended", [
            "active",
            "coordinatesEasting",
    ...
    unmounted () {
        ...
        this.unregisterListener({
            type: "click",
            listener: "Modules/CoordToolkitExtended/positionClicked",
    ...
    methods: {
        ...mapMutations("Modules/CoordToolkitExtended", Object.keys(mutations)),
        ...mapActions("Modules/CoordToolkitExtended", [
            "checkPosition",
            "changedPosition",
                ...
                <InputText
                    ...
                    >
                        <button
                            ...
                            type="button"
                            class="btn btn-outline-default inside px-3"
                            :title="$t(`additional:modules.coordToolkitExtended.copyHeightBtn`)"
